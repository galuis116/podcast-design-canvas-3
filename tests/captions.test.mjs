// tests/captions.test.mjs — WebVTT caption import model: parsing, validation,
// [start, end) activation semantics, and persistence across preset switches.
...
test("captions survive preset and template switches", () => {
  ...
  assert.equal(C.listCues(ep).length, 2);
  const template = PDC.templates.saveTemplate("Show layout", [{ x: 0, y: 0, w: 50, h: 100 }, { x: 50, y: 0, w: 50, h: 100 }]);
